...
MYSQL_PASSWORD= os.getenv("MYSQL_PASSWORD", quote_plus("root@143"))
...
engine = create_engine(
    ...
    echo=True,
    pool_pre_ping=True
) # Creating an engine instance using the constructed database URL to manage the connection to the database.
